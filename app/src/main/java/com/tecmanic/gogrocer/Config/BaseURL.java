...
public class BaseURL {
    static final String APP_NAME = "Tokrees";
    public static final String MyPrefreance = "my_preprence";

    public static final String PREFS_NAME = "TokreesLoginPrefs";
    public static final String PREFS_NAME2 = "TokreesLoginPrefs2";
    ...
    public static String BASE_URL = "http://tokrees.com/myapp/api/";
    public static String IMG_URL = "http://tokrees.com/myapp/";
    public static String BANN_IMG_URL = "http://tokrees.com/myapp/api/";
